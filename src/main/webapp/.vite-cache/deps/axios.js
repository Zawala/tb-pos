import { __export } from './chunk-DZ5VRGCL.js';
...
var isFormData = thing => {
  ...
  return (
    kind === 'formdata' || // detect form-data instance
...
var AxiosError = class _AxiosError extends Error {
  ...
  toJSON() {
    ...
    const serializedConfig =
      utils_default.isArray(redactKeys) && redactKeys.length > 0 ? redactConfig(config, redactKeys) : utils_default.toJSONObject(config);
    return {
      // Standard
...
var factory = env => {
  ...
  const supportsResponseStream =
    isResponseSupported && isReadableStreamSupported && test(() => utils_default.isReadableStream(new Response('').body));
  const resolvers = {
...
var Axios = class {
  ...
  _request(configOrUrl, config) {
    ...
    headers &&
      utils_default.forEach(['delete', 'get', 'head', 'post', 'put', 'patch', 'query', 'common'], method => {
