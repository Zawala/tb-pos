...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.tb.pos.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.tb.pos.security.DomainUserDetailsService", "createSpringSecurityUser");
